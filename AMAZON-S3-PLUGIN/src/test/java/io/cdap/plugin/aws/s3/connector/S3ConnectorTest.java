...
public class S3ConnectorTest {
  ...
  public static void setupTestClass() throws Exception {
    ...
    Assume.assumeFalse(String.format(messageTemplate, "endPoint"), endPoint == null);
...
/*    List<BrowseEntity> entities = new ArrayList<>();
    ...
    S3ConnectorConfig config = new S3ConnectorConfig(accessKey, secretKey, null, "Access Credentials", region, endPoint, bucket);

    S3Connector connector = new S3Connector(config);
...
//    S3BatchSource.S3BatchConfig  s3BatchConfig = new S3BatchSource.S3BatchConfig(config,"path");
//    s3BatchConfig.validate();
//    Schema schema = s3BatchConfig.getSchema();
